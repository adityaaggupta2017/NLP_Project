...
def parse_args():
    parser = argparse.ArgumentParser(description='Train the Improved Deception Detection Model')
...
def main():
    ...
    train_dataset = EnhancedDeceptionDataset(args.train_path, tokenizer, use_game_scores=args.use_game_scores)
    val_dataset = EnhancedDeceptionDataset(args.val_path, tokenizer, use_game_scores=args.use_game_scores)
