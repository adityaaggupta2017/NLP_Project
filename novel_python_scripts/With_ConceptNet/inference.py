...
from config import DEVICE, TRANSFORMER_MODEL, BATCH_SIZE, USE_GAME_SCORES, TRUTH_FOCAL_WEIGHT, CONCEPTNET_PATH
...
def parse_args():
    parser = argparse.ArgumentParser(description='Run inference with the Improved Deception Detection Model with ConceptNet')
